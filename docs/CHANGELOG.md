...
- TASK-001 / TAREA 6 (parcial): historial con columnas Año/Mes/Semana, buscador y filtros en el servidor (backend: `services/_analisis_historial.py`, 25 tests; frontend: filtros que no se desmontan durante la consulta, búsqueda con debounce, estado «sin resultados»). **No implementados** Eliminar ni Actualizar: falta la decisión de producto (los casos consolidados no están ligados a su carga; ver TASK-001 › Estado).
