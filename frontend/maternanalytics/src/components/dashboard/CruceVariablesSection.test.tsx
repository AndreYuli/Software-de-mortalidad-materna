...
describe('CruceVariablesSection: etiquetas dinámicas (DEC-002)', () => {
  ...
  it('nombra la variable en título y ejes sin duplicarla en la leyenda, y las actualiza al cambiarlas', async () => {
    ...
    expect(o.scales.x.title.text).toBe('Casos: N° de gestaciones')
    expect(o.scales.y.title.text).toBe('Zona de residencia')
    expect(o.plugins.legend.title).toBeUndefined()
    ...
    o = opciones()
    expect(o.scales.x.title.text).toBe('Casos: Cesáreas')
